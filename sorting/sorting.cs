// Dafny program sorting.dfy compiled into C#
...
// Command-line arguments: run --no-verify c:\homeProjects\Dafny\sorting.dfy
// sorting.dfy
...
method selectionSort(v: array<int>)
  ...
  ensures forall i: int, j: int {:trigger v[j], v[i]} :: 0 <= i < j < v.Length ==> v[i] <= v[j]
  decreases v
{
  var n := 0;
  while n < v.Length
    invariant 0 <= n <= v.Length
    invariant sameContent(v[..], old(v[..]))
    invariant forall i: int, j: int {:trigger v[j], v[i]} :: 0 <= i < n <= j < v.Length ==> v[i] <= v[j]
    invariant forall i: int, j: int {:trigger v[j], v[i]} :: 0 <= i < j < n ==> v[i] <= v[j]
    decreases v.Length - n
  {
    var min_index := n;
    var i := n + 1;
    while i < v.Length
      invariant n + 1 <= i <= v.Length
      invariant n <= min_index < v.Length
      invariant forall j: int {:trigger v[j]} :: n <= j < i ==> v[min_index] <= v[j]
...
namespace _module {
  ...
  public partial class __default {
    public static bool sameContent(Dafny.ISequence<BigInteger> a, Dafny.ISequence<BigInteger> b)
    {
      return (Dafny.MultiSet<BigInteger>.FromSeq((a))).Equals(Dafny.MultiSet<BigInteger>.FromSeq((b)));
    }
    public static void selectionSort(BigInteger[] v)
    {
      BigInteger _0_n;
      _0_n = BigInteger.Zero;
      while ((_0_n) < (new BigInteger((v).Length))) {
        BigInteger _1_min__index;
        _1_min__index = _0_n;
        BigInteger _2_i;
        _2_i = (_0_n) + (BigInteger.One);
        while ((_2_i) < (new BigInteger((v).Length))) {
          if (((v)[(int)(_2_i)]) < ((v)[(int)(_1_min__index)])) {
            _1_min__index = _2_i;
          }
    ...
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      ...
      _nw0[(int)((int)(BigInteger.One))] = new BigInteger(6);
      _nw0[(int)((int)(new BigInteger(2)))] = new BigInteger(8);
      ...
      _nw0[(int)((int)(new BigInteger(6)))] = new BigInteger(9);
      _nw0[(int)((int)(new BigInteger(7)))] = new BigInteger(3);
      _0_sorted = _nw0;
      __default.selectionSort(_0_sorted);
      Dafny.Helpers.Print((_0_sorted));
    }
  }
